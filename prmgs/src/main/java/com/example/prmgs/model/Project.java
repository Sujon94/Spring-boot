...
public class Project {
    ...
    public Project(String name, String intro, Date start_at, Date end_at, Long user_id, Long status_id, LocalDateTime created_at) {
        this.name = name;
        this.intro = intro;
    ...
    @Column(name = "start_at", columnDefinition = "DATE", nullable = true)
